...
export declare class ImgSrcDirective extends BaseDirective implements OnInit, OnChanges {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<ImgSrcDirective, "  img[src.xs],    img[src.sm],    img[src.md],    img[src.lg],   img[src.xl],  img[src.lt-sm], img[src.lt-md], img[src.lt-lg], img[src.lt-xl],  img[src.gt-xs], img[src.gt-sm], img[src.gt-md], img[src.gt-lg]", never, {
    "srcBase": "src";
    "srcXs": "src.xs";
    "srcSm": "src.sm";
    "srcMd": "src.md";
